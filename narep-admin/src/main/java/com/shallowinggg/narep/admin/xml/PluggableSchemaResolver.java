...
import com.shallowinggg.narep.core.util.PropertiesLoaderUtils;
...
public class PluggableSchemaResolver implements EntityResolver {
     ...
     */
    public static final String DEFAULT_SCHEMA_MAPPINGS_LOCATION = "META-INF/narep.schemas";
    ...
    public PluggableSchemaResolver(@Nullable ClassLoader classLoader, String schemaMappingsLocation) {
        Conditions.hasText(schemaMappingsLocation, "'schemaMappingsLocation' must not be empty");
        this.classLoader = classLoader;
