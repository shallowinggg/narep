...
final class TypeMappedAnnotation<A extends Annotation> extends AbstractMergedAnnotation<A> {
	...
	public <T extends Annotation> MergedAnnotation<T> getAnnotation(String attributeName, Class<T> type)
		...
		Conditions.notNull(type, "Type must not be null");
		Conditions.isAssignable(type, attribute.getReturnType(),
	...
	public <T extends Annotation> MergedAnnotation<T>[] getAnnotationArray(
		...
		Conditions.notNull(type, "Type must not be null");
		Conditions.notNull(componentType, () -> "Attribute " + attributeName + " is not an array");
		Conditions.isAssignable(type, componentType, () -> "Attribute " + attributeName + " component type mismatch:");
		return (MergedAnnotation<T>[]) getRequiredValue(attributeIndex, attributeName);
	}
	...
	public <T extends Map<String, Object>> T asMap(Function<MergedAnnotation<?>, T> factory, Adapt... adaptations) {
		...
		Conditions.checkState(map != null, "Factory used to create MergedAnnotation Map must not return null");
	...
	private int getAttributeIndex(String attributeName, boolean required) {
		Conditions.hasText(attributeName, "Attribute name must not be null");
	...
	static <A extends Annotation> MergedAnnotation<A> from(@Nullable Object source, A annotation) {
		Conditions.notNull(annotation, "Annotation must not be null");
	...
	static <A extends Annotation> MergedAnnotation<A> of(
		...
		Conditions.notNull(annotationType, "Annotation type must not be null");
