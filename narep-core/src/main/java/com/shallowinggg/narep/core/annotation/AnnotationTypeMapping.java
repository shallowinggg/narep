...
import com.shallowinggg.narep.core.annotation.AnnotationTypeMapping.MirrorSets.MirrorSet;
...
final class AnnotationTypeMapping {
	...
	private Method resolveAliasTarget(Method attribute, AliasFor aliasFor, boolean checkAliasPair) {
		if (StringTinyUtils.isNotBlank(aliasFor.value()) && StringTinyUtils.isNotBlank(aliasFor.attribute())) {
		...
		if (StringTinyUtils.isNotEmpty(targetAttributeName)) {
