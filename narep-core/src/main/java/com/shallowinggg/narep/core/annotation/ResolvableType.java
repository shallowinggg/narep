...
import com.shallowinggg.narep.core.annotation.SerializableTypeWrapper.FieldTypeProvider;
...
public class ResolvableType implements Serializable {
    ...
    private boolean isAssignableFrom(ResolvableType other, @Nullable Map<Type, Type> matchedBefore) {
        Conditions.notNull(other, "ResolvableType must not be null");
    ...
    public String toString() {
        ...
        if (hasGenerics()) {
            return this.resolved.getName() + '<' + StringTinyUtils.arrayToDelimitedString(getGenerics(), ", ") + '>';
        }
    ...
    public static ResolvableType forClass(Class<?> baseType, Class<?> implementationClass) {
        Conditions.notNull(baseType, "Base type must not be null");
    ...
    public static ResolvableType forClassWithGenerics(Class<?> clazz, Class<?>... generics) {
        ...
        Conditions.notNull(generics, "Generics array must not be null");
    ...
    public static ResolvableType forClassWithGenerics(Class<?> clazz, ResolvableType... generics) {
        ...
        Conditions.checkArgument(variables.length == generics.length, "Mismatched number of generics specified");
    ...
    public static ResolvableType forInstance(Object instance) {
        Conditions.notNull(instance, "Instance must not be null");
    ...
    public static ResolvableType forConstructorParameter(Constructor<?> constructor, int parameterIndex) {
        Conditions.notNull(constructor, "Constructor must not be null");
    ...
    public static ResolvableType forMethodReturnType(Method method) {
        Conditions.notNull(method, "Method must not be null");
    ...
    public static ResolvableType forMethodParameter(MethodParameter methodParameter,
        ...
        Conditions.notNull(methodParameter, "MethodParameter must not be null");
    ...
    public static ResolvableType forArrayComponent(ResolvableType componentType) {
        Conditions.notNull(componentType, "Component type must not be null");
