...
import com.shallowinggg.narep.core.asm.*;
...
final class SimpleAnnotationMetadataReadingVisitor extends ClassVisitor {
    ...
    public void visitEnd() {
        String[] memberClassNames = StringTinyUtils.toStringArray(this.memberClassNames);
    ...
    public SimpleAnnotationMetadata getMetadata() {
        Conditions.checkState(this.metadata != null, "AnnotationMetadata not initialized");
