...
public class FileSystemResource extends AbstractResource implements WritableResource {
    ...
    public FileSystemResource(String path) {
        Conditions.notNull(path, "Path must not be null");
        this.path = StringTinyUtils.cleanPath(path);
    ...
    public FileSystemResource(File file) {
        Conditions.notNull(file, "File must not be null");
        this.path = StringTinyUtils.cleanPath(file.getPath());
        this.file = file;
    ...
    public FileSystemResource(Path filePath) {
        Conditions.notNull(filePath, "Path must not be null");
        this.path = StringTinyUtils.cleanPath(filePath.toString());
        this.file = null;
    ...
    public FileSystemResource(FileSystem fileSystem, String path) {
        Conditions.notNull(fileSystem, "FileSystem must not be null");
        Conditions.notNull(path, "Path must not be null");
        this.path = StringTinyUtils.cleanPath(path);
        this.file = null;
     ...
     * @see StringTinyUtils#applyRelativePath(String, String)
     */
    @Override
    public Resource createRelative(String relativePath) {
        String pathToUse = StringTinyUtils.applyRelativePath(this.path, relativePath);
