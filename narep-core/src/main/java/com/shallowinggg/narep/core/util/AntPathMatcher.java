...
public class AntPathMatcher implements PathMatcher {
    ...
    public AntPathMatcher(String pathSeparator) {
        Conditions.notNull(pathSeparator, "'pathSeparator' is required");
    ...
    protected String[] tokenizePath(String path) {
        return StringTinyUtils.tokenizeToStringArray(path, this.pathSeparator, this.trimTokens, true);
    }
    ...
    public String extractPathWithinPattern(String pattern, String path) {
        String[] patternParts = StringTinyUtils.tokenizeToStringArray(pattern, this.pathSeparator, this.trimTokens, true);
        String[] pathParts = StringTinyUtils.tokenizeToStringArray(path, this.pathSeparator, this.trimTokens, true);
    ...
    public String combine(String pattern1, String pattern2) {
        if (StringTinyUtils.isBlank(pattern1) && StringTinyUtils.isBlank(pattern2)) {
            return "";
        }
        if (StringTinyUtils.isBlank(pattern1)) {
            return pattern2;
        }
        if (StringTinyUtils.isBlank(pattern2)) {
            return pattern1;
        }
