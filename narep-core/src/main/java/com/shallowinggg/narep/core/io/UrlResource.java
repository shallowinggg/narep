...
public class UrlResource extends AbstractFileResolvingResource {
    ...
    public UrlResource(URI uri) throws MalformedURLException {
        Conditions.notNull(uri, "URI must not be null");
        this.uri = uri;
        this.url = uri.toURL();
    ...
    public UrlResource(URL url) {
        Conditions.notNull(url, "URL must not be null");
        this.url = url;
     ...
     * @see StringTinyUtils#cleanPath
     */
    private URL getCleanedUrl(URL originalUrl, String originalPath) {
        String cleanedPath = StringTinyUtils.cleanPath(originalPath);
    ...
    protected URL createRelativeURL(String relativePath) throws MalformedURLException {
        ...
        relativePath = StringTinyUtils.replace(relativePath, "#", "%23");
    ...
    public String getFilename() {
        return StringTinyUtils.getFilename(this.cleanedUrl.getPath());
    }
