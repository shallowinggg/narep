...
public class MethodParameter {
    ...
    MethodParameter(Executable executable, int parameterIndex, @Nullable Class<?> containingClass) {
        Conditions.notNull(executable, "Executable must not be null");
    ...
    public MethodParameter(MethodParameter original) {
        Conditions.notNull(original, "Original must not be null");
    ...
    private static int validateIndex(Executable executable, int parameterIndex) {
        ...
        Conditions.isTrue(parameterIndex >= -1 && parameterIndex < count,
